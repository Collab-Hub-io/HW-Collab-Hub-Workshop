...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"bgcolor" : [ 0.980392156862745, 0.576470588235294, 0.023529411764706, 1.0 ],
					"id" : "obj-9",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 609.999997615814209, 382.5, 50.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 803.333335995674133, 520.5, 163.666660785675049, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.999996781349182, 147.0, 406.0, 38.0 ],
					"text" : "You can send control and event data to a specific room (in push or publish form) by building a message in the following format:",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 410.5, 28.0, 22.0 ],
					"text" : "2)",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 410.5, 298.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 407.0, 341.0, 126.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 162.5, 28.0, 22.0 ],
					"text" : "1)",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 162.5, 298.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 159.0, 341.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.999997615814209, 589.0, 85.0, 22.0 ],
					"text" : "s toCH-Server"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.999997615814209, 477.5, 117.0, 22.0 ],
					"text" : "sprintf push %s bam"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.5, 355.0, 446.166666746139526, 313.0 ],
					"proportion" : 0.39
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 619.499997615814209, 501.0, 783.166664958000183, 501.0 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 59.0, 1062.0, 594.0, 1062.0, 594.0, 471.0, 619.499997615814209, 471.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 284.5, 1017.0, 594.0, 1017.0, 594.0, 585.0, 619.499997615814209, 585.0 ],
					"source" : [ "obj-27", 0 ]
				}

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.666673183441162, 979.5, 43.999993443489075, 29.0 ],
					"text" : "or:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 830.333337068557739, 857.0, 205.666660785675049, 22.0 ],
					"text" : "Message sent to clients in room",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.999996781349182, 238.000002264976501, 403.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.999996781349182, 147.0, 399.333336353302002, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 736.5, 28.0, 22.0 ],
					"text" : "3)",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 736.5, 298.0, 179.0 ],
					"presentation_linecount" : 11,
					"text" : "You can collect a list of AvailableRooms into a umenu object by making a receive object that listens to 'fromCH-Server' and routing incoming data from the availableRoomsUmenu event listener.\n\nThe server will send an updated list of available rooms whenere a new room in your namespace is created. You can also request an updated lsit from the server by sending it the message 'getAvailableRooms'.",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 733.0, 341.0, 187.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 388.5, 28.0, 22.0 ],
					"text" : "2)",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 388.5, 298.0, 116.0 ],
					"presentation_linecount" : 7,
					"text" : "Rooms created by other clients will appear under AvailableRooms in the left window. Rooms that you create from this client will appear under MyRooms in the right window.\n\nYou can join and leave rooms using the umenus directly below each window.",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 385.0, 341.0, 126.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 983.0, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 1028.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 983.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 948.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.999999523162842, 891.0, 85.0, 22.0 ],
					"text" : "s toCH-Server"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 545.999999523162842, 764.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 652.666664958000183, 857.0, 174.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.999999523162842, 812.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 537.5, 391.0, 171.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 930.0, 391.0, 142.666667103767395 ],
					"proportion" : 0.39
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 555.499999523162842, 837.0, 573.666667938232422, 837.0, 573.666667938232422, 851.333334922790527, 817.166664958000183, 851.333334922790527 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 565.999999523162842, 797.0, 677.499999523162842, 797.0 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 59.0, 1062.0, 531.0, 1062.0, 531.0, 807.0, 555.499999523162842, 807.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 284.5, 1017.0, 531.0, 1017.0, 531.0, 885.0, 555.499999523162842, 885.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "CH-Client.maxpat",
				"bootpath" : "~/Max_Programs/ch_room_distribution_example/bpatchers",
...
, 			{
				...
				"bootpath" : "~/Documents/GitHub/SHPofTHSEUS/Collab-Hub-Max-Client/img/for-bpatchers",
				"patcherrelativepath" : "../../Documents/GitHub/SHPofTHSEUS/Collab-Hub-Max-Client/img/for-bpatchers",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
				"name" : "CH-ClientScript-v0.3beta.js",
				"bootpath" : "~/Max_Programs/ch_room_distribution_example",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
...
, 			{
				"name" : "CH-Logo.png",
				"bootpath" : "~/Max_Programs/ch_room_distribution_example/bpatchers/img",
				"patcherrelativepath" : "./bpatchers/img",
				"type" : "PNG",
				"implicit" : 1
			}
 ],
